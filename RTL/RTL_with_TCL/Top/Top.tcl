...
# Create interface ports
  ...
  # Create instance: Upsampling_IP_0, and set properties
  set Upsampling_IP_0 [ create_bd_cell -type ip -vlnv FTN:user:Upsampling_IP:1.0 Upsampling_IP_0 ]
...
Reset#SD 0#UART 1#UART 1#GPIO#GPIO#Enet 0#Enet 0}\
 ...
 # Create instance: ps7_0_axi_periph, and set properties
  ...
  connect_bd_intf_net -intf_net Upsampling_IP_0_m_axi [get_bd_intf_pins Upsampling_IP_0/m_axi] [get_bd_intf_pins axi_mem_intercon/S00_AXI]
  connect_bd_intf_net -intf_net axi_mem_intercon_M00_AXI [get_bd_intf_pins axi_mem_intercon/M00_AXI] [get_bd_intf_pins processing_system7_0/S_AXI_HP0]
  connect_bd_intf_net -intf_net processing_system7_0_DDR [get_bd_intf_ports DDR] [get_bd_intf_pins processing_system7_0/DDR]
  connect_bd_intf_net -intf_net processing_system7_0_FIXED_IO [get_bd_intf_ports FIXED_IO] [get_bd_intf_pins processing_system7_0/FIXED_IO]
  connect_bd_intf_net -intf_net processing_system7_0_M_AXI_GP0 [get_bd_intf_pins processing_system7_0/M_AXI_GP0] [get_bd_intf_pins ps7_0_axi_periph/S00_AXI]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M00_AXI [get_bd_intf_pins Upsampling_IP_0/s_axi] [get_bd_intf_pins ps7_0_axi_periph/M00_AXI]

  # Create port connections
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins Upsampling_IP_0/m_axi_aclk] [get_bd_pins Upsampling_IP_0/s_axi_aclk] [get_bd_pins axi_mem_intercon/ACLK] [get_bd_pins axi_mem_intercon/M00_ACLK] [get_bd_pins axi_mem_intercon/S00_ACLK] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins processing_system7_0/S_AXI_HP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_100M/slowest_sync_clk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_100M/ext_reset_in]
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins Upsampling_IP_0/m_axi_aresetn] [get_bd_pins Upsampling_IP_0/s_axi_aresetn] [get_bd_pins axi_mem_intercon/ARESETN] [get_bd_pins axi_mem_intercon/M00_ARESETN] [get_bd_pins axi_mem_intercon/S00_ARESETN] [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_100M/peripheral_aresetn]
...
if { [get_property IS_LOCKED [ get_files -norecurse Upsampling_blockdesign.bd] ] == 1  } {
  import_files -fileset sources_1 [file normalize "$resultDir/project_1.gen/sources_1/bd/Upsampling_blockdesign/hdl/Upsampling_blockdesign_wrapper.vhd" ]
} else {
  set wrapper_path [make_wrapper -fileset sources_1 -files [ get_files -norecurse Upsampling_blockdesign.bd] -top]
...
if {$version < 2019.2} {
    file mkdir $resultDir/Upsampling_blockdesign.sdk
    file copy -force $resultDir/Upsampling_blockdesign.runs/impl_1/Upsampling_blockdesign_wrapper.sysdef $resultDir/Upsampling_blockdesign.sdk/Upsampling_blockdesign_wrapper.hdf
} else {
    write_hw_platform -fixed -include_bit -force -file $resultDir/Upsampling_blockdesign_wrapper.xsa
}
